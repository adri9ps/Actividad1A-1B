...
public class GestionFicherosImpl implements GestionFicheros {
	...
	public void creaCarpeta(String arg0) throws GestionFicherosException {
       ...
       //que no exista -> lanzar� una excepci�n
		if(file.exists()){
			throw new GestionFicherosException("existe");
		}else{
			file.mkdir();
		}
	...
	public void creaFichero(String arg0) throws GestionFicherosException {
		...
		try {
			  if (!f.createNewFile())
				  ...
				  throw new GestionFicherosException("No se ha podido crear");
	...
	public void elimina(String arg0) throws GestionFicherosException {
		File f2 = new File(carpetaDeTrabajo,arg0);

			if(f2.delete()){
				throw new GestionFicherosException("Se ha eliminado");
	...
	if (file.canRead())
		strBuilder.append("Se puede leer");
	else 
		throw new GestionFicherosException("No se puede leer");
		...
		strBuilder.append("Ultima modificación: "+file.lastModified());
		strBuilder.append("\n");
		...
		if(file.isDirectory())
			...
			strBuilder.append("Espacio libre: "+file.list().length);
		strBuilder.append("\n");
		if(file.isFile())
			strBuilder.append("Espacio total: "+file.length());
		strBuilder.append("\n");
	...
	public void renombra(String arg0, String arg1)
			throws GestionFicherosException {
		// TODO Auto-generated method stub
		File f1 = new File(carpetaDeTrabajo,arg0);
		File f2 = new File(carpetaDeTrabajo,arg1);
